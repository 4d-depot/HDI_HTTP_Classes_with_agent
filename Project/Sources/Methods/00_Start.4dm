...
Case of 
	: (Count parameters:C259=0)
		...
		If (Application version:C493<"1960")  // 19R6
			ALERT:C41("Sorry, this \"How do I\" (HDI) example must be used with a newer version of 4D (v19 R6 and above)"; "Quit")
			QUIT 4D:C291
		Else 
	...
	Else 
		...
		$options.title:="A weather application using the new HTTP classes to request a REST API!"
		
		$options.blog:="blog.4d.com"
		$options.info:="4D Application"  //ex : "4D View Pro feature"
